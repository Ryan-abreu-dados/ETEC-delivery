...
function Inicio({ email, aoSair }) {
  ...
  return <div className="store-page">
    <header className="store-header"><a className="store-logo" href="#inicio">karma<span>.</span></a><nav aria-label="Navegacao principal"><a href="#inicio">Inicio</a><a href="#cardapio">Cardapio</a><a href="/dashboard">Dashboard</a></nav><div className="header-actions"><Botao classe="cart-button" aoClicar={() => setCarrinhoAberto(true)}>Carrinho <b>{totalItens}</b></Botao><Botao classe="profile-button" aoClicar={aoSair}>Sair</Botao></div></header>
